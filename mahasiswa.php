...
<body>
  ...
  <?php 
    ...
    $sql = ociparse($conn, "SELECT NAMA, NRP, ANGKATAN, KELAS, NO_TELP FROM PERPUSTAKAAN.MAHASISWA");
    ociexecute($sql);
  ...
  <div class="row" style="max-width: 100vw;">
    ...
    <div class="col-10 p-4">
      <div class="card p-4" style="min-height: 100%;">
        ...
        <div class="my-2">
          <a class="py-2 px-4 bg-main text-white rounded" href="./buku/tambah.php">Tambah Mahasiswa</a>
        </div>
        <!-- table -->
